          ...
          <div class="heropart row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3">
            <div class="col-lg-77 p-3 p-lg-5 pt-lg-3">
              <div class="lc-block mb-3">
                <div editable="rich">
                  <p
                    style={{ fontSize: "3.5rem", letterSpacing: "3px" }}
                    class="fw-bold display-4"
                  >
                    Watch
                    <br /> Connect <br /> Heal<p></p>
                    <p></p>
                  </p>
                </div>
              </div>
              ...
              <div class="lc-block mb-3 my-4">
                <div editable="rich ">
                  <p class="lead">
                    Watch expert doctor videos, book appointments, and get the
                    treatment you need.
                  </p>
                </div>
              </div>
              ...
              <div class="lc-block d-grid gap-2 d-md-flex justify-content-md-start my-4">
                <a
                  ...
                  href="#"
                  role="button"
                  style={{ padding: "0.7rem", backgroundColor: "#133682" }}
                >
                  Watch Videos
                </a>
                <a
